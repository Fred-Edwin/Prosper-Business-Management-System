...
`pnpm build` green. Branch `feat/catalog-low-stock-threshold`, not yet
merged. Local dev database was reset (`prisma migrate reset`, explicit
user consent) mid-session to resolve migration-history drift from
