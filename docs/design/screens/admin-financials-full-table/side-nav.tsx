// The admin-shell side nav, transcribed verbatim from the Paper artboard "Admin Financials —
// Full Table" (7ZJ-0) side-nav frame via get_jsx. "Financials" is the active item. Shared by
// both Financials screens (full-table + payment-drawer-open) so the ~130 lines aren't
// duplicated. The brand image is replaced with a local mark. Static: no interactivity.
"use client";

import * as React from "react";

export function AdminShellSideNav() {
  return (
    <div className="flex flex-col w-[240px] shrink-0 self-stretch bg-(--nav-bg)">
      ...
      <div className="flex flex-col pt-[8px] pb-[4px] px-[6px]">
        <div className="flex items-center h-[36px] px-[10px] rounded-sm gap-[8px] relative shrink-0">
          ...
          <div className="absolute left-[0px] top-[6px] bottom-[6px] w-[2px] rounded-tr-[2px] rounded-br-[2px] hidden bg-(--nav-text-active)" />
        </div>
      </div>
      ...
      <div className="flex flex-col py-[4px] px-[6px]">
        ...
        <div className="flex items-center h-[36px] px-[10px] rounded-sm gap-[8px] relative shrink-0 bg-(--nav-bg-active)">
          ...
          <div className="font-ui font-(--weight-medium) inline-block text-(--nav-text-active) text-sm/micro">Financials</div>
