...
| 3-KIT | Developer (kit) | `SESSION-3KIT.md` | **DISPATCHED** — build + ADR-42-gate `SelectableProductRow` from `JL7-0`. Blocks 3c/3d. |
...
| 3a | Developer | `SESSION-3A.md` | **READY TO DISPATCH** — Admin merged Sales screen + F7-4 + F7-8. Blocked only on B2 being merge-ready (it is). Concurrent with 3-DESIGN/3-DOMAIN. |
| 3b | Developer | `SESSION-3B.md` | **READY TO DISPATCH** — Admin mobile: Ledger, Financials, Assets + A1 Customers filter-toolbar conversion. Concurrent with 3a. |
| 3c | Developer | _drafted after 3-DESIGN + 3-DOMAIN + 3-KIT_ | SM flow screens rebuild. Blocked on 3-DESIGN, 3-DOMAIN, 3-KIT. |
| 3d | Developer | _drafted after 3c inputs land_ | Canteen screens rebuild + F7-7. Blocked on 3-DESIGN, 3-DOMAIN, 3-KIT. |
| FINAL | Tech Lead | _not yet drafted_ | Blocked on all above + owner walkthroughs. |
