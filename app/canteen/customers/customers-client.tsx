// Canteen — Customers list + repayment (mirrors C6, the Cashier's
// customers-client.tsx, verbatim). ADR-91 follow-up (2026-09-23): a
// canteen credit sale creates a Debt against a customer; the attendant
// needs a way to collect on it later, the same as a Cashier does for a
// Restaurant credit order. Reuses the same kit composition, the same
// shared `RepaymentForm` (app/admin/customers/repayment-form.tsx), and
// the same `useCustomers` hook — nothing canteen-specific about how a
// repayment is recorded, only who may reach this screen (gated by
// app/canteen/layout.tsx).
"use client";
...
/** Same balance readout as C6 — "KES 1,200" danger / "Settled" tertiary. */
...
export function CanteenCustomersClient() {
        ...
        <EmptyState
          ...
          description={
            search.trim()
              ...
              : "Customers are added when you record a credit sale."
          }
        />
      ) : (
        <div className="flex flex-col [width:100%]">
