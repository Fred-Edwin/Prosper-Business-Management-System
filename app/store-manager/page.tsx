...
// Store Manager Mobile Hub screen once wired to live data.
export default function StoreManagerHomePage() {
  return (
    <div className="flex h-full w-full flex-col items-center justify-center gap-2 px-8 text-center">
      <h2 className="font-ui text-h1/h1 font-semibold text-text-primary">Receipt screens are coming in a later sprint</h2>
